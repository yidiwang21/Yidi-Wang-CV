...
\begin{document}
  ...
  \documentTitle{Yidi Wang}{
    ...
    \href{mailto:user@domain.tld}{
      \raisebox{-0.15\height} \faEnvelope\ yidi.wang@scu.edu} ~ | ~
...
%        \item Coursework: Real-Time Embedded Systems, Advanced Operating Systems, Design and Analysis of Algorithms, GPU Architecture and Parallel Programming
  ...
  \begin{justify}
  \begin{itemize}
    \item Mohsen Karimi, \textbf{Yidi Wang}, Youngbin Kim, Yoojin Lim, and Hyoseung Kim. CARTOS: A Charging-Aware Real-Time Operating System for Intermittent Batteryless Devices. In IEEE Transactions on Emerging Topics in Computing (TETC), 2025.
    ...
    \item Marcus Chen, Pascal Reich, \textbf{Yidi Wang}, and Hyunjong Choi. Work-in-Progress: A Practical Linux Framework for Weakly-Hard Tasks with Constant Bandwidth Server. In Brief Presentation Session of IEEE Real-Time Systems Symposium (RTSS), 2025.
...
\end{resume_list}
  ...
  \begin{itemize}
    \itemalign{ACM/IEEE Design Automation Conference (DAC)}{2026}
    \itemalign{IEEE Real-Time System Symposium (RTSS) - Brief Presentations}{2025}
    \itemalign{IEEE Real-Time System Symposium (RTSS)}{2025}
    \itemalign{ACM Transactions on Architecture and Code Optimization (TACO)}{2025}
    \itemalign{ACM Transactions on Internet of Things (TIOT)}{2025}
    \itemalign{IEEE Real-Time and Embedded Technology and Applications Symposium (RTAS) - Brief Presentations}{2024}
    \itemalign{IEEE Transactions on Computers (TC)}{2024}
    \itemalign{ACM Transactions on Embedded Computing Systems (TECS)}{2023 -- 2024}
    \itemalign{ACM Transactions on Cyber-Physical Systems (TCPS)}{2023 -- 2024}
    ...
    \itemalign{IEEE Real-Time Systems Symposium (RTSS), Secondary Reviewer}{2021}
  \end{itemize}
