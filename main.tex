...
%        \item Coursework: Real-Time Embedded Systems, Advanced Operating Systems, Design and Analysis of Algorithms, GPU Architecture and Parallel Programming
  ...
  \begin{justify}
  \begin{itemize}
    \item Mohsen Karimi, \textbf{Yidi Wang}, Youngbin Kim, Yoojin Lim, and Hyoseung Kim. CARTOS: A Charging-Aware Real-Time Operating System for Intermittent Batteryless Devices. In IEEE Transactions on Emerging Topics in Computing (TECS), 2025.
